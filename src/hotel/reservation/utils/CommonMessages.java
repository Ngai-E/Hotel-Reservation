...
public class CommonMessages {
    //menus
    public static final String FIND_A_ROOM = "Find and reserve a room";
    public static final String SEE_RESERVATIONS = "See my reservations";
    ...
    //create account
    public static final String ENTER_FIRSTNAME = "Enter your first name";
    public static final String ENTER_LASTNAME = "Enter your last name";
    ...
    public static final  String INVALID_INPUT_CANNOT_BE_EMPTY = "Input can not be empty!!";
    public static final  String INVALID_INPUT_MUST_BE_A_NUMBER = "Input must me a number!!";
    public static final  String INVALID_INPUT_NON_NEGATIVE = "Input must greater than zero!!";
    public static final  String INVALID_INPUT_DATE = "Input date is invalid enter date in the format mm/dd/yyyy !!";
